...
const Checkout = () => {
  ...
  return (
    ...
    <form className='bg-white px-5 py-2 mt-7'>
     ...
     <div className="border-b border-gray-900/10 pb-12">
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 py-5 px-5 my-3 border-solid border-2 border-gray-200">
    ...
    <div className="mx-auto mt-12 bg-white max-w-7xl px-0 py-5 sm:px-0 lg:px-0">
   <h1 className="text-4xl font-bold tracking-tight text-gray-900 mb-1 px-1">Cart</h1>
